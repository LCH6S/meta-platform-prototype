...
const applications = [
  ...
  },
  {
    ...
    invoiceType: "专票",
    buyer: "上海明恒商业管理有限公司",
    buyerTaxNo: "91310104685512345A",
    seller: "上海收钱吧科技有限公司",
    sellerTaxNo: "9131000066935277XR",
    invoiceNo: "2531200000041599003",
    invoiceStatus: "开票成功",
    businessType: "REAL_ESTATE_LEASE",
  },
  {
  ...
  },
  {
    ...
    invoiceType: "红字普票",
    buyer: "上海森活零售有限公司",
    buyerTaxNo: "91310120MA1HX88888",
    seller: "上海收钱吧科技有限公司",
    sellerTaxNo: "9131000066935277XR",
    invoiceNo: "2531200000041599042",
    invoiceStatus: "红冲成功",
    businessType: "NONE",
  },
  {
            ...
            <tbody>
              ${rows.length ? rows.map((item, index) => `
                <tr>
                  ...
                  <td>${state.taskTab === "processed" ? item.invoiceStatus : item.businessType === "NONE" ? taskListBusinessLabel(item.businessType) : `<span class="tag special">${businessLabel(item.businessType)}</span>`}</td>
